...
#                                 idelstatus=1       
#                    else:
#                        #card_no=readCardData()
#                        
                       string = input("enter card or swip the card: ")
                       print("CARD No.is :"+string)
                       card_raw_data=string
#                        card_raw_data=readCardData()
                       ...
                       if (vArr[0]=="37"):
                            print(vArr[1])
                            binary_data=bin(int(str(vArr[1]), 16))[2:].zfill(37)
                            ...
                            print(vArr[1])
                            binary_data=bin(int(str(vArr[1]), 16))[2:].zfill(26)
                            print(binary_data)
                            ...
                            print(vArr[1])
                            hex_data=int(str(vArr[1]), 16)
                            print(hex_data)
                            binary_data=bin(int(str(vArr[1]), 16))[2:].zfill(35)
                            print(binary_data)
                            print(binary_data)
                            BC1=binary_data[0:3]
